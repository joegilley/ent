...
//go:generate go run -mod=mod github.com/jogly/ent/cmd/ent generate --feature privacy ./schema
```
...
```go
//go:generate go run -mod=mod github.com/jogly/ent/cmd/ent generate --feature privacy,schema/snapshot ./schema
```
