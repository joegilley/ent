...
func (fq *FileQuery) QueryProcesses() *ProcessQuery {
	query := (&ProcessClient{config: fq.config}).Query()
...
func (fq *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if query := fq.withProcesses; query != nil {
		if err := fq.loadProcesses(ctx, query, nodes,
...
func (fq *FileQuery) loadProcesses(ctx context.Context, query *ProcessQuery, nodes []*File, init func(*File), assign func(*File, *Process)) error {
